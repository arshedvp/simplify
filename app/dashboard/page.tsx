...
export default function Home() {
  ...
  if (isLoading) {
    return <div className="bg-gradient-to-br from-pink-200 to-blue-200 min-h-screen flex items-center justify-center text-gray-700">Loading...</div>;// Display a loading spinner or message
  }
  else{
